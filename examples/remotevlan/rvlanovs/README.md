...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanovs?ref=eb5c014d0ef4d67413babb2c1ce1c7f2acdf4f09
```
...
```bash
kubectl delete -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanovs?ref=eb5c014d0ef4d67413babb2c1ce1c7f2acdf4f09
```
