...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/spire/cluster1
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/spire/cluster1/clusterspiffeid-template.yaml
```

```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/spire/base/clusterspiffeid-webhook-template.yaml
```
