...
```bash
kubectl apply -k ../../../examples/observability/jaeger-and-prometheus
```
...
```bash
kubectl apply -k ../../../examples/observability/jaeger-and-prometheus/nsm-system
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../examples/observability/jaeger-and-prometheus/example
```
