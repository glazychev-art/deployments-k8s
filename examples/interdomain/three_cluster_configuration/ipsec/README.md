...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/three_cluster_configuration/ipsec/cluster1
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/three_cluster_configuration/ipsec/cluster2
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/three_cluster_configuration/ipsec/cluster3
```
