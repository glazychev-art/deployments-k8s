...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../examples/interdomain/nsm_istio/networkservice.yaml
```

Start `alpine` with networkservicemesh client on the first cluster:

```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../examples/interdomain/nsm_istio/greeting/client.yaml
```

Start `auto-scale` networkservicemesh endpoint:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/nsm_istio/nse-auto-scale
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -f ../../../examples/interdomain/nsm_istio/greeting/server.yaml
