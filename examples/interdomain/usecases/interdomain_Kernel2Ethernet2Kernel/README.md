...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/interdomain_Kernel2Ethernet2Kernel/cluster2
```
...
Deploy client:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/interdomain_Kernel2Ethernet2Kernel/cluster1
```
