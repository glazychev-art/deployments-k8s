...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-proxy-nsmgr-death/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_interdomain-proxy-nsmgr-death/cluster1
```
