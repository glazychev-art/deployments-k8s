...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/heal_floating-nsm-system-death/cluster3
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_floating-nsm-system-death/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_floating-nsm-system-death/cluster1
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/three_cluster_configuration/basic/cluster1
```

```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/three_cluster_configuration/basic/cluster2
```

```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/three_cluster_configuration/basic/cluster3
```
