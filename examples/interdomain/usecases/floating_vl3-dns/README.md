...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster3
```

1.2. Deploy a vl3-NSE and a client on the cluster1:

```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster1
```
```bash
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster2
```
```bash
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 delete -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster3
```

2. Cleanup cluster2 domain:
```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster2
```

3. Cleanup cluster1 domain:
```bash
kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/interdomain/usecases/floating_vl3-dns/cluster1
```
