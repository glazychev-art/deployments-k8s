...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/heal_floating-forwarder-death/cluster3
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/heal_floating-forwarder-death/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/heal_floating-forwarder-death/cluster1
```
