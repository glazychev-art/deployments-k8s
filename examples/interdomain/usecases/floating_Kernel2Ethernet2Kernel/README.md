...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Kernel/cluster3
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Kernel/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/floating_Kernel2Ethernet2Kernel/cluster1
```
