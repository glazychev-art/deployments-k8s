...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster1
```

```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster2
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster1
```

```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/interdomain/usecases/nsm_consul_vl3/cluster2
```
