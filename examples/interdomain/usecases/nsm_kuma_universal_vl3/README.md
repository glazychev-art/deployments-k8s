...
1. Start vl3
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/vl3-dns
...
```
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/namespace.yaml
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/demo-redis.yaml
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../examples/interdomain/usecases/nsm_kuma_universal_vl3/demo-app.yaml
