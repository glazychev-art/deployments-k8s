...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/interdomain/nsm_consul/nse-auto-scale
```
...
```
```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../examples/interdomain/nsm_consul/nse-auto-scale
```
```bash
