...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/interdomain/two_cluster_configuration/basic/cluster1
```

Apply NSM resources for cluster2:

```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/interdomain/two_cluster_configuration/basic/cluster2
```
