...
```bash
kubectl apply -k ../../../examples/use-cases/Kernel2RVlanMultiNS/ns-1
```

Deployment in second namespace:
```bash
kubectl apply -f ../../../examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml
...
```bash
kubectl apply -n nsm-system -f ../../../examples/use-cases/Kernel2RVlanMultiNS/client.yaml
```
...
```bash
kubectl delete --namespace=nsm-system -f ../../../examples/use-cases/Kernel2RVlanMultiNS/client.yaml
```
