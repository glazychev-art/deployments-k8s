...
```bash
NAMESPACE1=($(kubectl create -f ../../../../examples/floating_interdomain/usecases/namespace.yaml)[0])
...
Create test namespace:
```bash
NAMESPACE2=($(kubectl create -f ../../../../examples/floating_interdomain/usecases/namespace.yaml)[0])
