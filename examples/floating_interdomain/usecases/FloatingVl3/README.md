...
```bash
kubectl apply -k ../../../../examples/floating_interdomain/usecases/FloatingVl3/cluster3
```
...
```bash
kubectl apply -k ../../../../examples/floating_interdomain/usecases/FloatingVl3/cluster1
```
...
```bash
kubectl apply -k ../../../../examples/floating_interdomain/usecases/FloatingVl3/cluster2
```
...
```bash
export KUBECONFIG=$KUBECONFIG3 && kubectl delete -k ../../../../examples/floating_interdomain/usecases/FloatingVl3/cluster3
```

2. Cleanup cluster2 domain:

```bash
export KUBECONFIG=$KUBECONFIG2 && kubectl delete -k ../../../../examples/floating_interdomain/usecases/FloatingVl3/cluster2
```

3. Cleanup cluster1 domain:

```bash
export KUBECONFIG=$KUBECONFIG1 && kubectl delete -k ../../../../examples/floating_interdomain/usecases/FloatingVl3/cluster1
```
