...
```bash
kubectl apply -k ../../../examples/floating_interdomain/spire/cluster1
```
...
```bash
kubectl apply -k ../../../examples/floating_interdomain/spire/cluster2
```
...
```bash
kubectl apply -k ../../../examples/floating_interdomain/spire/cluster3
```
