...
```bash
kubectl apply -k ../../../examples/features/change-nse-dynamically
```

```bash
kubectl apply -f ../../../examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f ../../../examples/features/change-nse-dynamically/green-netsvc.yaml
```
