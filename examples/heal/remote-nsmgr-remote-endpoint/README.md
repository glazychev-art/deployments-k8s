...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../examples/heal/remote-nsmgr-remote-endpoint/nsmgr-before-death
```
...
```
```bash
kubectl apply -k ../../../examples/heal/remote-nsmgr-remote-endpoint/nsmgr-after-death
```
