...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/multicluster/usecases/floating_dns/cluster3
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/multicluster/usecases/floating_dns/cluster2
```
...
Deploy client:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/multicluster/usecases/floating_dns/cluster1
```
