...
Deploy NS:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Vxlan2Kernel/cluster3
```
...
Deploy NSE:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Vxlan2Kernel/cluster2
```
...
Deploy NSC:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Vxlan2Kernel/cluster1
```
