...
Deploy NSE:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Vxlan2Kernel/cluster2
```
...
Deploy client:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Vxlan2Kernel/cluster1
```
