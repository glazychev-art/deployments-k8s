...
Deploy NSE:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Wireguard2Kernel/cluster2
```
...
Deploy NSC:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/interdomain_Kernel2Wireguard2Kernel/cluster1
```
