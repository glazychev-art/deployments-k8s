...
Deploy NS:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Wireguard2Kernel/cluster3
```
...
Deploy NSE:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Wireguard2Kernel/cluster2
```
...
Deploy NSC:
```bash
kubectl apply -k ../../../../examples/multicluster/usecases/floating_Kernel2Wireguard2Kernel/cluster1
```
