...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster3
```

Deploy a vl3-NSE and a client on the cluster1:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster1
```

Deploy a vl3-NSE and a client on the cluster2:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster2
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 delete -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster3
```

Cleanup cluster2 domain:
```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster2
```

Cleanup cluster1 domain:
```bash
kubectl --kubeconfig=$KUBECONFIG1 delete -k ../../../../examples/multicluster/usecases/floating_vl3-basic/cluster1
```
