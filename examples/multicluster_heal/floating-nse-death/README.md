...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../examples/multicluster_heal/floating-nse-death/cluster3
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/multicluster_heal/floating-nse-death/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/multicluster_heal/floating-nse-death/cluster1
```
