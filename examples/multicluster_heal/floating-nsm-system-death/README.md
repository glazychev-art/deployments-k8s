...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../examples/multicluster_heal/floating-nsm-system-death/cluster3
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/multicluster_heal/floating-nsm-system-death/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/multicluster_heal/floating-nsm-system-death/cluster1
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/multicluster/clusters-configuration/cluster1
```

```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/multicluster/clusters-configuration/cluster2
```

```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../examples/multicluster/clusters-configuration/cluster3
```
