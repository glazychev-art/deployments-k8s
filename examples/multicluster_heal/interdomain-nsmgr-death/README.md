...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../examples/multicluster_heal/interdomain-nsmgr-death/cluster2
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../examples/multicluster_heal/interdomain-nsmgr-death/cluster1
```
